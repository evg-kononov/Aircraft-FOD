...
вместе с защитным вибростойским стеклом, корпус с системой крепления.
  ...
  будет освещен, следовательно, сложнее отследить ПП. (<span style="color:red"> сделать расчеты зависимости требуемой
  частоты кадров для совершения N снимков от расстояния до датчика ПОД </span>)
...
на скорости до 300 км/час. 
  - <span style="color:red"> И что? Какие ограничения в данном случае накладываются на камеру? <span>

**Критерии успеха:**
- Количество совершенных снимков ППП <span style="color:red"> (определить уровень) <span>;
